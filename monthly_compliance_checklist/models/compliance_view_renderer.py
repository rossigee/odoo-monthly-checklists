...
class ComplianceViewRenderer(models.TransientModel):
    ...
    def get_check_type_view(self, check_type, view_type='form'):
        ...
        for model_name in self.env.registry:
            ...
            if (hasattr(model_class, '_compliance_check_type') and 
                model_class._compliance_check_type == check_type):
        ...
        for model_name in self.env.registry:
            ...
            if (hasattr(model_class, '_compliance_check_type') and 
                ...
                if hasattr(model_instance, 'validate_configuration'):
                    ...
                    if check_validation:
                        validation_result['errors'].extend(check_validation.get('errors', []))
                        validation_result['warnings'].extend(check_validation.get('warnings', []))
    ...
    def get_check_type_help_text(self, check_type):
        ...
        return help_data.get(check_type, {
            'description': 'Custom compliance check type',
            'examples': [],
            'tips': []
        })
    ...
    def get_available_check_types_with_info(self):
        ...
        for model_name in self.env.registry:
            ...
            if (hasattr(model_class, '_compliance_check_type') and 
                ...
                help_info = self.get_check_type_help_text(model_class._compliance_check_type)
